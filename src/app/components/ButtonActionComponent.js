...
export default function ButtonActionComponent({
  href,
  children,
  action = 'link',
  onConfirmDelete,
  onSubmit,
  modalComponent: ModalComponent, // opsional, bisa di-pass dari parent
  className = '',
  ...props
}) {
  ...
  // ✅ Action = create → buka modal khusus jika ModalComponent dikirim
  if (action === 'create' && ModalComponent) {
    return (
      <>
        <Button
          size="sm"
